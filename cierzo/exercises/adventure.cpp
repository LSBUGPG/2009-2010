...
lock_grate:
	printf(
		"\n"
		"As you lock the grate a dragon hears the key turning and tries\n"
		"to angrily break through the grate, but thanks to you it is trapped\n"
		"and cannot escape and because of you the wildlife of the forest is\n"
		"no longer going to be terrorised by the demonic dragon!\n"
		"\n");
...
kill_dragon:
	printf(
		"\n"
		"You fight the dragon with your bare hands! But unsurprisingly the dragon\n"
		"rips you to pieces, although you fought bravely it was always a mismatch.\n"
		"\n");

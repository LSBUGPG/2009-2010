...
void describe_forest(void)
{
	...
	get_answer();
	if (answer_contains(words_enter_hut))
	{
		enter_hut();
	}
	else if (answer_contains(words_follow_stream))
	{
		follow_stream();
	}
	else
...
void describe_hut(void)
{
	...
	if (have_key)
	{
		...
		get_answer();
		if (answer_contains(words_go_outside))
		{
			leave_hut();
		}
		else if (answer_contains(words_return_key))
		{
			return_key();
		}
		else
	...
	else
	{
		...
		else if (answer_contains(words_take_key))
		{
			take_key();
		}
		else
...
void describe_streambed(void)
{
	...
	if (grate_locked && have_key)
	{
		...
		get_answer();
		if (answer_contains(words_go_upstream))
		{
			return_to_forest();
		}
		else if (answer_contains(words_open_grate))
		{
			unlock_grate();
		}
		else
	...
	else if (have_key)
	{
		...
		else if (answer_contains(words_enter_grate))
		{
			enter_cave();
		}
		else if (answer_contains(words_lock_grate))
		{
			lock_grate();
		}
		else
...
void describe_cave(void)
{
	...
	if (!last_chance)
	{
		...
		get_answer();
		if (answer_contains(words_fight_dragon))
		{
			barehanded_are_you_sure();
		}
		else if (answer_contains(words_flee))
		{
			flee();
		}
		else
	...
	else
	{
		...
		get_answer();
		if (answer_contains(words_fight_dragon_barehanded))
		{
			kill_dragon();
		}
		else if (answer_contains(words_flee))

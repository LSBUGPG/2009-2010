...
SoundKey sound_key[] =				//this is the part you have to modify for the exercise
{
	SoundKey("ball.bmp",
			 "letter_b.bmp",
			 "bounce.wav",
...
int main(int argc, char *argv[])
{
	...
	const int FREQUENCY = 34100; // I also changed this so Buttheads voice is lower and more realistic.
	const int STEREO = 2;

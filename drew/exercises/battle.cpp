...
void do_attempt_flee(void)
{
		...
		(tie && player_initiative_modifier > monster_initiative_modifier))
	{
		...
		current = player_flees;
	}
	else
	{
		printf("The %s gets another turn.\n", monster_type);
		current = monster_turn;
	}
}
...
void do_player_turn(void)
{
	...
	// Removed to stop stage change conflict
	//else
	//{
...
int main(int argc, char *argv[])
{
	...
	do
	{
		...
		case player_flees:
			printf("and lives to fight another day\n");
			current = end;
			break;

...
void set_start(Object &object)
{
	...
	object.velocity[0] = 5000.0f;
	object.velocity[1] = -5000.0f;
}
...
GLfloat distance_to_top(const Object &object)
{
	return TOP - (object.position[1] + object.radius);
}
...
void update(Object &object, float t)
{
	...
	GLfloat u = distance_to_top(object);
	...
	if (u < 0.0f)
	{
		object.position[1] = TOP - object.radius + u;
		object.velocity[1] *= -1.0f;

...
{
	const GLfloat NORMAL_IMAGE_SIZE = 100.0f;
	const GLfloat ZOOM_IMAGE_SIZE	= 110.0f;
	const GLfloat PROMPT_SIZE		= 30.0f;
	...
	pos.coordinate[0] -= 0;
	pos.coordinate[1] -= ZOOM_IMAGE_SIZE + PROMPT_SIZE + 10;
	size = PROMPT_SIZE;

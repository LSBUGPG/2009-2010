...
void init_score(void)
{
	...
	load_audio(score_sound, "1.tshutup.wav");	// use load_audio to load "score.wav"
}
...
// I basically copied Affan's work and changed the soundfile, as I don't really understand too much of what is written above, or too much of any of the C++ that we have been shown so far.
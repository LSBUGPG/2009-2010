...
const triangle t[] = 
{
	{ 
		...
		{
			{    0.0f,  100.0f }, // point 1
			{  100.0f, -50.0f }, // point 2
			{ -100.0f, -50.0f }  // point 3     &t[0],
		}
	},

			{ 
		{ 0, 255, 0 }, // Green Over Red
		{
			{    0.0f,  100.0f }, // point 1
			{  50.0f, -50.0f }, // point 2
			{ -50.0f, -50.0f }  // point 3	&t[1],
		}
	},
	...
	{ 
		...
		{
			{    0.0f,  200.0f }, // point 1
			{  100.0f, 100.0f }, // point 2
			{ -100.0f, 100.0f }  // point 3			&t[4],
		}
	},

			{ 
		{ 255, 0, 0 }, // Red Over Green
		{
			{    0.0f,  200.0f }, // point 1
			{  50.0f, 100.0f }, // point 2
			{ -50.0f, 100.0f }  // point 3		&t[5],
		}
	},
			{ 
		{ 0, 0, 255 }, // Blue 1
		{
			{ 150.0f, 0.0f }, // point 1
			{ 320.0f, -200.0f }, // point 2
			{ 0.0f, -200.0f }  // point 3		&t[6],
		}
	},
		{ 
		{ 255, 255, 255}, // White 1 
		{
			{    150.0f, 0.0f }, // point 1
			{  320.0f, 240.0f }, // point 2
			{ 100.0f, 100.0f }  // point 3		&t[7],
		}
	},

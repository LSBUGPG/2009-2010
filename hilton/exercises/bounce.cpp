...
GLfloat distance_left(const Object &object)
{
return (object.position[0] - object.radius) - LEFT;
};
GLfloat distance_right(const Object &object)
	{
...
void update(Object &object, float t)
{
	...
	GLfloat l = distance_left(object);
	GLfloat r = distance_right(object);

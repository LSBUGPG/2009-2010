...
int player_initiative_modifier =	get_modifier(player_dexterity) + 
									player_level / 2;
const char *player_name = "Spencer";
const char *player_weapon = "War Hammer";
...
const char *monster_type = "Goblin Berserker";
const char *monster_weapon = "Sickle";
...
void do_player_power_attack(void)
{
	printf("%s makes a %s Power attack on the %s.\n", player_name, player_weapon, monster_type);
